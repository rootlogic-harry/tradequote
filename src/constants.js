...
export const PHOTO_SLOTS = [
  ...
  { key: 'referenceCard', label: 'Reference Card', instruction: 'Place your FastQuote Reference Card flat against the wall face and photograph it clearly', required: true },
