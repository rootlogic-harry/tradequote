...
export const PHOTO_SLOTS = [
  { key: 'overview', label: 'Overview', instruction: 'Full damaged section, straight on, landscape orientation', required: false },
  { key: 'closeup', label: 'Close-up', instruction: 'Worst damage area — show the collapse and scattered stone', required: false },
  ...
  { key: 'referenceCard', label: 'Reference Card', instruction: 'Place your TradeQuote Reference Card flat against the wall face and photograph it clearly', required: false },
