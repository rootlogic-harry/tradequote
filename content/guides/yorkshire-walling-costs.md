...
Stone supply is the easiest thing about quoting Yorkshire work. The county has working quarries in every district — Yorkshire-grade walling stone delivered runs roughly **£80 to £140 per tonne**, depending on the cut and the distance. Reclaimed Yorkshire stone is a touch more (£140 to £200 per tonne) but easier to match on older walls. See the [stone tonnage guide](/guides/stone-tonnage) for how much to order.

## Typical day rates

For solo experienced wallers across Yorkshire:

- **Field-boundary work, rural Yorkshire** — £220 to £280 per day.
- **Garden / heritage work, urban West Yorkshire** — £260 to £330 per day.
- **Yorkshire Dales National Park context** — £260 to £340 per day. Higher visual standard, sometimes a DSWA-graded requirement.
- **Listed-property or conservation work** — £300 to £400 per day, often with a DSWA Advanced grade in the brief.
...
- **Rural Yorkshire (Dales fringe, Pennines, Wolds)** — £140 to £190 per metre.
- **West Yorkshire urban / suburban** — £160 to £220 per metre.
- **Inside Yorkshire Dales National Park boundary** — £170 to £230 per metre, sometimes higher for heritage spec.
- **Garden walls (1m, single-skin, finer faces)** — £130 to £190 per metre.

For more on what the per-metre figure includes, see the [cost per metre guide](/guides/cost-per-metre).
...
- **Pennine wind.** A solo waller on a 1.4m wall in 35mph wind off the moor is not building safely. Build in a weather day per fortnight in the spring and autumn quote.
- **Access via single-track lanes.** Common across the Dales fringe. A 16-tonne tipper cannot always reach the gate.
- **Public footpaths.** A lot of Yorkshire walls are alongside footpaths or rights of way. You are not stopping the walker — you are pausing the build, every time.

## What is good about Yorkshire work

- **Stone supply is local and well-priced.** Compared to Cotswold limestone, Yorkshire gritstone is a third less per tonne delivered.
- **Customer awareness is high.** Yorkshire customers know what a good wall costs and what a good waller looks like. Trust is faster to build.
- **The Dales and Moors have ongoing public-money work.** Heritage rebuilds funded by the National Park authorities, Countryside Stewardship schemes and DEFRA agri-environment grants are a steady backbone of paid work for graded wallers.

FastQuote's profile carries your day rate and your trading region, so a Yorkshire quote prices off Yorkshire numbers without needing to be re-set every time.

Related: [Cost per metre](/guides/cost-per-metre) · [DSWA day rates](/guides/dswa-day-rate) · [Cotswold walling costs](/guides/cotswold-walling-costs)
