...
- **Chapter 8 mention if it applies.** Roadside boundary walls need traffic management. Either include it in the quote or be explicit that it is a separate cost. See the [Chapter 8 traffic management guide](/guides/chapter-8-traffic-management).
...
- **[Cost per metre to rebuild a dry stone wall](/guides/cost-per-metre)** — UK ranges by stone type, wall height, and region. Honest numbers, with what they include.
- **[How long does it take to rebuild a dry stone wall?](/guides/how-long-to-rebuild)** — operative-day-per-metre benchmarks, what slows a job down, what speeds it up.
- **[How much stone do I need? Estimating tonnage for a wall rebuild](/guides/stone-tonnage)** — the 1-tonne-per-square-metre rule, single-skin vs double-faced, sourcing reclaimed stone.
- **[What should a dry stone walling quote include?](/guides/whats-in-a-quote)** — checklist with the why behind each line. The "send this to a waller mate" article.
- **[DSWA-style day rates — what to charge and when to flex](/guides/dswa-day-rate)** — what the DSWA grading levels imply for your rate, when day-rate beats per-metre.
- **[Dry stone walling costs in Yorkshire](/guides/yorkshire-walling-costs)** — gritstone, sandstone, the boundary-wall convention, regional rate norms.
- **[Dry stone walling costs in the Cotswolds](/guides/cotswold-walling-costs)** — Cotswold limestone, conservation expectations, the golden-stone aesthetic premium.
- **[Do I need Chapter 8 traffic management for roadside walls?](/guides/chapter-8-traffic-management)** — when it applies, kit costs, who supplies it, how to price it on the quote.
