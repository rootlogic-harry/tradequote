...
The 1-tonne-per-square-metre rule still applies, but Cotswold work often warrants 15 per cent over-order because the cut wastage is higher. See the [stone tonnage guide](/guides/stone-tonnage).
...
A garden wall in a Cotswold village with vertical copestones, hand-cut quoins and a defined string line is closer to £260 to £340 per metre than the field-boundary rate. The spec drives the price more than the metreage does. See the [cost per metre guide](/guides/cost-per-metre) for what these ranges include.
...
- **AONB-funded heritage rebuilds** — grant-funded work has spec attached. The grant officer will read your scope paragraph. Be specific. See the [what's in a quote guide](/guides/whats-in-a-quote).
...
Related: [Cost per metre](/guides/cost-per-metre) · [DSWA day rates](/guides/dswa-day-rate) · [Yorkshire walling costs](/guides/yorkshire-walling-costs)
